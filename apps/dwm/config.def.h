...
static const Layout layouts[] = {
	/* symbol     arrange fuSchemeSelnction */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, "-bf", selbgcolor, "-bw", "2", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("screenshot -s") },
	...
	{ MODKEY|ShiftMask,             XK_Left,  spawn,          SHCMD("xrandr --output eDP1 --rotate right") },
	{ MODKEY|ShiftMask,             XK_Up,     spawn,          SHCMD("xrandr --output eDP1 --rotate normal") },
	{ MODKEY|ShiftMask,             XK_Right,   spawn,          SHCMD("xrandr --output eDP1 --rotate left") },
